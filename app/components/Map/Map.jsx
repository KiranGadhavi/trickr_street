...
//   const [isVisible, setIsVisible] = useState(false);
//   const [zoomLevel, setZoomLevel] = useState(12);
//   const [hoveredMarkerId, setHoveredMarkerId] = useState(null); // State to track hovered marker
...
//               onClick={() => handleLegendItemClick(marker)}
//               onMouseEnter={() => setHoveredMarkerId(marker.id)} // Set hovered marker on mouse enter
//               onMouseLeave={() => setHoveredMarkerId(null)} // Clear hovered marker on mouse leave
//             >
//               <FaMapMarkerAlt className="text-orange-500 mr-2" />
//               <span className="relative">
//                 {hoveredMarkerId === marker.id ? (
//                   <Image
//                     src="/images/ghost-pumpkin.png" // Path to the ghost image
//                     alt="Ghost Pumpkin"
//                     width={40} // Adjust width as necessary
//                     height={40} // Adjust height as necessary
//                     className="absolute top-0 left-0 transform -translate-x-1/2 -translate-y-1/2 opacity-75"
//                   />
//                 ) : (
//                   marker.name
//                 )}
//                 (Avg. Rating: {getAverageRating(marker.id)}⭐)
//               </span>
//             </li>
//           ))}
//         </ul>
